...
VIDEO_FILE_PATH = r"E:\forklifter\2026-02-09\A00001_163620_005.mkv" # Change this to your video path
    ...
    def _processing_loop(self):
        ...
        while self.running and not shutdown_event.is_set():
            try:
                ...
                if "current_prediction" in state:
                    cv2.putText(
                        display_frame,
                ...
                # container_number = ocr_handler.get_container_number(self.kalmar_id)
                container_list = ocr_handler.get_container_numbers(self.kalmar_id)

                if container_list:
                    cv2.putText(
                        display_frame,
                        f"Containers: {', '.join(container_list)}",
                        (10, 120),
                        cv2.FONT_HERSHEY_SIMPLEX,
                        0.6,
                        (0, 255, 255),
                ...
                elif ocr_handler.is_ocr_in_progress(self.kalmar_id):
                    cv2.putText(
                        display_frame,
                        "OCR Processing...",
                        (10, 120),
                ...
                elif pickup_duration > 0 and pickup_duration < 5.0:
                    cv2.putText(
                        display_frame,
